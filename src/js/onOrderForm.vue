...
<div class="col-lg-8 col-lg-offset-2 text-center">
	...
	<hr>
	<h3 class="text-center">Отправьте нам запрос на изготовление готовой продукции или полуфабрикатов под заказ: <br> <br>Сэндвичи, Бутерброды, Хлеб, Торты, Выпечка, Круассаны с начинками, Кексы, Салаты и другое!</h3>
	<hr>
