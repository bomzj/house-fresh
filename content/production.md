...
description: "<span class='text-primary'>Внимание!</span> Указаны <strong>ОПТОВЫЕ / МЕЛКООПТОВЫЕ цены</strong> (при сумме заказа от 35руб). <br> Срок исполнения заявки в зависимости от объёма - от 1 дня."
