...
description: "<span class='text-primary'>Внимание!</span> Указаны <strong>ОПТОВЫЕ / МЕЛКООПТОВЫЕ цены</strong> (заказ от 35руб). Скидка при заказе от 80руб. <br> Срок исполнения заявки в зависимости от объёма - от 1 дня."
