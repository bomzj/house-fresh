...
metadescription: "Оптовая продукция: Сэндвичи из багета, Торты, Выпечка, Круассаны, Маффины, Хлеб, Салаты (Мелкий опт). Доставка в Кафе, Кофейню. Охлаждённые и Замороженные. Цены производителя | ХаусФреш Минск"
metakeywords: "Готовая продукция оптом: Сэндвичи из багета, Мини багеты, Торты, Выпечка, Круассаны, Маффины, Хлеб, Салаты. Оптовые и Мелкооптовые цены. Охлаждённые и Замороженные. Торты, Выпечка, Бутерброды на заказ."
...
- categoryTitle: Салаты 
  issueDate: "Срок хранения и реализации готовых салатов: при t°от +2°Cдо +6°C - 12 часов заправленные, 18 часов не заправленные"
  categoryId: salads
  items:
